 ...
 */
    function(t,i){"undefined"!=typeof IScroll&&(IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)}),t.iscrollHandler={refreshId:null,iScrollInstances:[],toggleWheel:function(t){i(".fp-section.active").find(".fp-scrollable").each(function(){var e=i(this).data("iscrollInstance");void 0!==e&&e&&(t?e.wheelOn():e.wheelOff())})},onLeave:function(){iscrollHandler.toggleWheel(!1)},beforeLeave:function(){iscrollHandler.onLeave()},afterLoad:function(){iscrollHandler.toggleWheel(!0)},create:function(t,e,s){var o=t.find(".fp-scrollable");o.height(e),o.each(function(){var t=i(this),e=t.data("iscrollInstance");e&&i.each(iscrollHandler.iScrollInstances,function(){i(this).destroy()}),e=new IScroll(t.get(0),s),e.on("scrollEnd",function(){this.fp_isAtTop=this.y>-30,this.fp_isAtEnd=this.y-this.maxScrollY<30}),iscrollHandler.iScrollInstances.push(e),e.wheelOff(),t.data("iscrollInstance",e)})},isScrolled:function(t,i){var e=i.data("iscrollInstance");return!e||("top"===t?e.y>=0&&!i.scrollTop():"bottom"===t?0-e.y+i.scrollTop()+1+i.innerHeight()>=i[0].scrollHeight:void 0)},scrollable:function(t){return t.find(".fp-slides").length?t.find(".fp-slide.active").find(".fp-scrollable"):t.find(".fp-scrollable")},scrollHeight:function(t){return t.find(".fp-scrollable").children().first().get(0).scrollHeight},remove:function(t){var i=t.find(".fp-scrollable");if(i.length){var e=i.data("iscrollInstance");e&&e.destroy(),i.data("iscrollInstance",null)}t.find(".fp-scrollable").children().first().children().first().unwrap().unwrap()},update:function(t,e){clearTimeout(iscrollHandler.refreshId),iscrollHandler.refreshId=setTimeout(function(){i.each(iscrollHandler.iScrollInstances,function(){i(this).get(0).refresh()})},150),t.find(".fp-scrollable").css("height",e+"px").parent().css("height",e+"px")},wrapContent:function(){return'<div class="fp-scrollable"><div class="fp-scroller"></div></div>'}}}(window,window.jQuery),function(t,i,e){e.fn.fp_scrolloverflow=function(){function s(){function s(){e("body").hasClass(l)?p():h(n)}function n(i){if(!i.hasClass("fp-noscroll")){i.css("overflow","hidden");var s,n=d.options.scrollOverflowHandler,r=n.wrapContent(),h=i.closest(o),l=n.scrollable(i),c=parseInt(h.css("padding-bottom"))+parseInt(h.css("padding-top"));l.length?s=n.scrollHeight(i):(s=i.get(0).scrollHeight-c,d.options.verticalCentered&&(s=i.find(a).get(0).scrollHeight-c));var p=e(t).height()-c;s>p?l.length?n.update(i,p):(d.options.verticalCentered?i.find(a).wrapInner(r):i.wrapInner(r),n.create(i,p,d.iscrollOptions)):n.remove(i),i.css("overflow","")}}function h(t){e(o).each(function(){var i=e(this).find(r);i.length?i.each(function(){t(e(this))}):t(e(this))})}function p(){var t=d.options.scrollOverflowHandler;h(function(i){i.closest(o).hasClass(c)&&t.remove(i)})}var d=this;d.options=null,d.init=function(o,n){return d.options=o,d.iscrollOptions=n,"complete"===i.readyState&&(s(),e.fn.fullpage.shared.afterRenderActions()),e(t).on("load",function(){s(),e.fn.fullpage.shared.afterRenderActions()}),d},d.createScrollBarForAll=s}var o=".fp-section",n=o+".active",r=".fp-slide",h=r+".active",a=".fp-tableCell",l="fp-responsive",c="fp-auto-height-responsive";IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)};var p={refreshId:null,iScrollInstances:[],iscrollOptions:{scrollbars:!0,mouseWheel:!0,hideScrollbars:!1,fadeScrollbars:!1,disableMouse:!0,interactiveScrollbars:!0},init:function(i){var o="ontouchstart"in t||navigator.msMaxTouchPoints>0||navigator.maxTouchPoints;return p.iscrollOptions.click=o,p.iscrollOptions=e.extend(p.iscrollOptions,i.scrollOverflowOptions),(new s).init(i,p.iscrollOptions)},toggleWheel:function(t){e(n).find(".fp-scrollable").each(function(){var i=e(this).data("iscrollInstance");void 0!==i&&i&&(t?i.wheelOn():i.wheelOff())})},onLeave:function(){p.toggleWheel(!1)},beforeLeave:function(){p.onLeave()},afterLoad:function(){p.toggleWheel(!0)},create:function(t,i,s){var o=t.find(".fp-scrollable");o.height(i),o.each(function(){var t=e(this),i=t.data("iscrollInstance");i&&e.each(p.iScrollInstances,function(){e(this).destroy()}),i=new IScroll(t.get(0),s),p.iScrollInstances.push(i),i.wheelOff(),t.data("iscrollInstance",i)})},isScrolled:function(t,i){var e=i.data("iscrollInstance");return!e||("top"===t?e.y>=0&&!i.scrollTop():"bottom"===t?0-e.y+i.scrollTop()+1+i.innerHeight()>=i[0].scrollHeight:void 0)},scrollable:function(t){return t.find(".fp-slides").length?t.find(h).find(".fp-scrollable"):t.find(".fp-scrollable")},scrollHeight:function(t){return t.find(".fp-scrollable").children().first().get(0).scrollHeight},remove:function(t){var i=t.find(".fp-scrollable");if(i.length){i.data("iscrollInstance").destroy(),i.data("iscrollInstance",null)}t.find(".fp-scrollable").children().first().children().first().unwrap().unwrap()},update:function(t,i){clearTimeout(p.refreshId),p.refreshId=setTimeout(function(){e.each(p.iScrollInstances,function(){e(this).get(0).refresh()})},150),t.find(".fp-scrollable").css("height",i+"px").parent().css("height",i+"px")},wrapContent:function(){return'<div class="fp-scrollable"><div class="fp-scroller"></div></div>'}};return{iscrollHandler:p}}()}(window,document,window.jQuery);
